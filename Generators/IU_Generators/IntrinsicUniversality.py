...
class IUGenerators:
    ...
    def EqualityGadgetGenerator(self):
        ...
        aff = uc.AffinityRule(row_signal_intermediate_accept.label,
        ...
        tr = uc.TransitionRule(signal_transmitter_turn_down_active.label, signal_door_handle_inactive.label,
        ...
        tr = uc.TransitionRule(signal_door_handle_open.label, signal_door_inactive.label,
        ...
        aff = uc.AffinityRule(signal_door_open.label,
                              endcap_door_west_stop.label, "h", 1)
        endcap_equality_gadget_sys.addAffinity(aff)
        aff = uc.AffinityRule(signal_door_reset.label,
                              endcap_door_west_reset.label, "h", 1)
        endcap_equality_gadget_sys.addAffinity(aff)

        tr = uc.TransitionRule(signal_door_open.label, endcap_door_west_stop.label,
        ...
        aff1 = uc.AffinityRule(signal_transmitter_turn_up_active.label,
                               endcap_door_west_handle_reset.label, "v", 1)
        endcap_equality_gadget_sys.addAffinity(aff1)

        aff2 = uc.AffinityRule(signal_transmitter_turn_up_reset.label,
                               endcap_door_west_handle_inactive.label, "v", 1)
        ...
        aff1 = uc.AffinityRule(row_signal_positive_full_accept.label,
                               signal_transmitter_turn_up_reset.label, "h", 1)
        endcap_equality_gadget_sys.addAffinity(aff1)

        aff2 = uc.AffinityRule(row_signal_positive_reset.label,
                               signal_transmitter_turn_up_inactive.label, "h", 1)
        endcap_equality_gadget_sys.addAffinity(aff2)
        ...
        aff2 = uc.AffinityRule(signal_transmitter_turn_down_reset.label,
...
check_equal_S_end_state_inactive = uc.State(
...
### Doors
endcap_door_west_inactive = uc.State(
    "EndcapDoorWestInactive", grey, "◨", "black")
endcap_door_west_handle_inactive = uc.State(
    "EndCapDoorHandleWestInactive", grey, "◨🔒", "black")
endcap_door_west_active = uc.State(
    "EndcapDoorWestActive", persian_green, "◨", "black")
endcap_door_west_handle_active = uc.State(
    "EndCapDoorHandleWestActive", persian_green, "◨🔓", "black")
endcap_door_west_stop = uc.State(
    "EndcapDoorWestStop", Venetian_Red, "◨", "black")
endcap_door_west_handle_stop = uc.State(
    "EndCapDoorWestHandleStop", Venetian_Red, "◨🔒", "black")
endcap_door_west_reset = uc.State(
    "EndcapDoorWestReset", mango_tango, "↺◨", "black")
endcap_door_west_handle_reset = uc.State(
    "EndCapDoorHandleWestReset", mango_tango, "↺◨🔒", "black")
endcap_door_west_handle_reset_waiting = uc.State(
...
signal_door_handle_inactive = uc.State(
...
row_signal_intermediate_accept = uc.State(
    "RowSignalPositiveInterimAccept", pistachio, "✅")
row_signal_positive_reset = uc.State(
...
reprogram_verifier_eq_gadget = uc.State(

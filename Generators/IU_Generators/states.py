    ...
    def wireWriterStatesGenerate(self):
        ...
        for i in range(0, 10):
            for key, value in self.dWire.items():
                ...
                dl = "🖋{}{}".format(value, i)
                self.states_dict[l] = uc.State(l, Air_Superiority_Blue, dl)
                l = "wireWriter{}{}Inactive".format(key, i)
                dl = "🖋{}{}ⁱ".format(value, i)
                self.states_dict[l] = uc.State(l, Light_Steel_Blue, dl)

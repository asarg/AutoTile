...
trap_door_active = State("TrapDoorActive", Barn_Red, "TD")

### Copy Up
copy_up = State("CopyUp", light_blue, "⇈")
copy_down = State("CopyDown", light_blue, "⇊")
copy_left = State("CopyLeft", light_blue, "⇇")
copy_right = State("CopyRight", light_blue, "⇉")

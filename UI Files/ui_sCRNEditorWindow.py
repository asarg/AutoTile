...
class Ui_EditorWindow(object):
    ...
    def retranslateUi(self, EditorWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("EditorWindow", "Add Reactant"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("EditorWindow", "Add Reaction"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("EditorWindow", "Board"))

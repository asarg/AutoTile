...
class Ui_EditorWindow(object):
    def setupUi(self, EditorWindow):
        ...
        self.tableGraphicsView.setGeometry(QtCore.QRect(10, 0, 171, 291))
        self.tableGraphicsView.setObjectName("tableGraphicsView")
        # self.tableGraphicsView.setColumnCount(0)
        # self.tableGraphicsView.setRowCount(0)
        self.graphicsView = QtWidgets.QGraphicsView(self.page_5)
        self.graphicsView.setGeometry(QtCore.QRect(200, 0, 541, 291))

...
# Form implementation generated from reading ui file 'sCRNEditorWindow.ui'
#
...
class Ui_EditorWindow(object):
    def setupUi(self, EditorWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 769, 385))
        self.page.setObjectName("page")
        self.tableWidget = QtWidgets.QTableWidget(self.page)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 571, 371))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 769, 385))
        self.page_2.setObjectName("page_2")
        self.tableWidget_3 = QtWidgets.QTableWidget(self.page_2)
        self.tableWidget_3.setGeometry(QtCore.QRect(0, 0, 571, 381))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 769, 385))
        self.page_3.setObjectName("page_3")
        self.graphicsView = QtWidgets.QGraphicsView(self.page_3)
        self.graphicsView.setGeometry(QtCore.QRect(200, 0, 561, 381))
        self.graphicsView.setObjectName("graphicsView")
        self.tableGraphicsView = QtWidgets.QGraphicsView(self.page_3)
        self.tableGraphicsView.setGeometry(QtCore.QRect(0, 0, 161, 381))
    ...
    def retranslateUi(self, EditorWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("EditorWindow", "Add State"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("EditorWindow", "Add Transition Rule"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("EditorWindow", "Seed"))

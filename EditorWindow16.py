...
class Ui_EditorWindow(object):
    def setupUi(self, EditorWindow):
        ...
        # Page 2 of editor; Seed Assembly 
       ...
       # Page 5; Transition Rules
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 765, 340))
    ...
    def shapesTest(self, seedAssembly):
       ...
       # font.setPixelSize(self.textSize)
        ...
        for seed in seedAssembly:

            brush.setColor(QtGui.QColor("#" + seed.get_color()))
            seed = self.scene.addRect(0, 0, 50, 50, self.pen, brush)
            seed.setFlag(QGraphicsItem.ItemIsMovable)

        # it puts the second square on top of the first square
       # square2 = self.scene.addRect(0, 0, 50, 50, self.pen, self.greenBrush)
        #square2.setFlag(QGraphicsItem.ItemIsMovable)
    ...
    def retranslateUi(self, EditorWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page_2), _translate("EditorWindow", "Seed Assembly"))
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page_3), _translate("EditorWindow", "Add State"))
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page_4), _translate("EditorWindow", "Add Affinity Rule"))
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page_5), _translate("EditorWindow", "Add Transition Rule"))
